...
1b. load necessary packages

## TASK: MERGE THE TRAINING AND TEST SETS TO CREATE ONE DATA SET##
2a. load the train data in 3 tables
2b. load the test data in 3 tables
2c. merge the 3 tables by row binding
2d. set the variable names of subject and labels
2e. set the variable names of the data
2f. load the variable names
2g. set the variable names
2h. merge the datasets
